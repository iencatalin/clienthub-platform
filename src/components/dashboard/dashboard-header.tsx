...
export function DashboardHeader() {
  ...
  return (
    <header className='h-16 shrink-0 flex items-center shadow-md bg-white rounded-lg gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12'>
      ...
      <div className='md:ml-auto flex items-center gap-2 pr-1 md:pr-4'>
        {showButton && (
          <Link
            href='/tickets/new'
